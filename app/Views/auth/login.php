                                    ...
                                    <?php if ($config->validFields === ['email']): ?>
                                        <div class="form-group">
                                            <input type="email" class="form-control form-control-user  <?php if(session('errors.login')) : ?>is-invalid<?php endif ?>"
                                                ...
                                                placeholder=placeholder="<?=lang('Auth.email')?>">
								...
								<?= session('errors.password') ?>
                                        ...
                                        <div class="form-group">
                                            <div class="custom-control custom-checkbox small">
                                                ...
                                                <?php if(old('remember')) : ?> checked <?php endif ?> for="customCheck"><?=lang('Auth.rememberMe')?></label>
                                            </div>
                                        </div>
                                        <?php endif; ?>
                                    ...
                                    <div class="text-center">
                                    <p> <a class="small" href="register.html"><a href="<?= route_to('register') ?>"><?=lang('Auth.needAnAccount')?></a></p>
                                    </div>
                                    <?php endif; ?>
                                    <?php if ($config->activeResetter): ?>
                                        <div class="text-center">
					                    <p><a href="<?= route_to('forgot') ?>" class="small"><?=lang('Auth.forgotYourPassword')?></a></p>
                                        </div>
                                    <?php endif; ?>
                                </div>
                            </div>
